...
const ArrayView<const double, 0> array_view_0{data(array_0)};
const ArrayView<const double, 3> array_view_3{data(array_3)};
const ArrayView<const double, 5> array_view_5{data(array_5)};

const ArrVecView<const double, 0> arrvec_view_0{data(vector_0), 0};
...
const VectorView<const double> vector_view_0{data(vector_0), 0, 0};
