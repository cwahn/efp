...
//         return *(reinterpret_cast<PackAt<n, Nothing, T>*>(_storage));
//     }
...
//         return efp::move(*(reinterpret_cast<const PackAt<n, Nothing, T>*>(_storage)));
//     }
...
//         return efp::move(*(reinterpret_cast<PackAt<n, Nothing, T>*>(_storage)));
//     }
...
// private:
//     alignas(maximum_v(alignof(Nothing), alignof(T))) uint8_t _storage[maximum_v(sizeof(Nothing), sizeof(T))];
//     uint8_t _index;
// };
