...
// ! efp
// class appender_efp : public std::back_insert_iterator<efp::Vector<char>>
// {
//     using base = std::back_insert_iterator<efp::Vector<char>>;

// public:
//     using std::back_insert_iterator<efp::Vector<char>>::back_insert_iterator;
//     appender(base it) noexcept : base(it) {}
//     FMT_UNCHECKED_ITERATOR(appender);
