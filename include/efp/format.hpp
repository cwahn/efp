...
struct CharsToString<TypeSeq<Char<c>, Rests>, cs...>: public CharsToString<Rests, cs..., c> {};
...
struct FormatStringImpl {
    ...
    static constexpr bool is_string = IsSame<char, CVRemoved<PointerRemoved<RawType>>>::value;
    ...
    using UIntXFormat = Conditional<
        is_size_t && is_x_fmt,
        SubstituteTypeSeq<SubstituteTypeSeq<RawFormat, Char<'d'>, Char<'x'>>, Char<'u'>, Char<'x'>>,
        RawFormat>;
    ...
    using FilteredFL = RemoveTypeSeq<RemoveTypeSeq<FL, Char<'x'>>, Char<'s'>>;
...
struct FindBrace<TypeSeq<Char<C>, InList>, OutList, N>:
    ...
    static_assert(
        C != '{',
        "Found nested braces: {...{...}...}! Maybe you want to mask the outer one?"
    );
};
...
struct CFormatStringImpl<TypeSeq<Char<'%'>, TypeSeq<Char<'%'>, SL>>, Types> {
    using Type =
        TypeSeq<Char<'%'>, TypeSeq<Char<'%'>, typename CFormatStringImpl<SL, Types>::Type>>;
};
...
struct CFormatStringImpl<TypeSeq<Char<'{'>, SL>, Types> {
    ...
    using Type = TypeSeq<
        Char<'%'>,
        AppendTypeSeq<FmtStr, typename CFormatStringImpl<RestString, typename Types::Tail>::Type>>;
};
